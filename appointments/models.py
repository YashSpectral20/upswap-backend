...
class Appointment(models.Model):
    ...
    time_slot = models.ManyToManyField(TimeSlot, related_name='appointments')
    ...
    def __str__(self):
        return f"Appointment {self.id} - {self.customer.username} with {self.vendor.full_name} for {self.service.name}"
