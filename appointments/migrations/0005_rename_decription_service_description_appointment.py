# Generated by Django 5.0 on 2025-06-05 07:34
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('appointments', '0004_servicecategory_vendor'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vendor_appointments', to='main.vendorkyc')),
            ],
            options={
                'ordering': ['-created_at'],
            },
